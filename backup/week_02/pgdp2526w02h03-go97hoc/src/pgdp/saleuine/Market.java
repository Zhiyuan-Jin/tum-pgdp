...
public class Market {
    public double priceCrustaceans;
    public double priceAnchovies;
    public double priceSardines;
    public int soldCrustaceansDay;
    public int soldAnchoviesDay;
    public int soldSardinesDay;
    public int daysInBusiness;
    public double moneyMadeDay;
    public double moneyMadeTotal;
