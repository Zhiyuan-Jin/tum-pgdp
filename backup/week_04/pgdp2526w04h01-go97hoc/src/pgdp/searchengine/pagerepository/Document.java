...
//TODO 5: Implement the method yearsSinceRelease & daysSinceLastUpdate
// and set the lastUpdateDate to the current date.
public class Document {
    ...
    public int yearsSinceRelease() {
        ...
        return releaseDate.yearsUntil(today);
    }
    public int daysSinceLastUpdate() {
        Date today = Date.today();
        return lastUpdateDate.daysUntil(today);
    }
